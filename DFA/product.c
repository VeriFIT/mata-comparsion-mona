...
extern void make_loop (bdd_manager *bddm, unsigned  p, unsigned q);
...
extern int make_a_loop_status (int is_loop_p, int status_p, int is_loop_q, int status_q, char *binfun);
