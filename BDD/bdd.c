...
extern unsigned lookup_cache(bdd_manager *bddm, unsigned *h, unsigned p, unsigned q);
...
extern void insert_cache(bdd_manager *bddm, unsigned h, unsigned p, unsigned q, unsigned res);
...
extern bdd_ptr bdd_get_free_node_sequential(bdd_manager *bddm);
...
extern unsigned bdd_find_leaf_sequential(bdd_manager *bddm, unsigned val);
...
extern unsigned bdd_find_node_hashed(bdd_manager *bddm,
					  unsigned l, unsigned r, unsigned indx,
					  unsigned *some_roots,
					  void (*update_fn)(unsigned 
							    (*new_place)(unsigned node)));
...
extern bdd_ptr bdd_find_node_hashed_add_root(bdd_manager *bddm, bdd_ptr l, bdd_ptr r, unsigned indx);
...
inline bdd_handle bdd_handle_find_node_hashed_add_root(bdd_manager *bddm, bdd_ptr l, bdd_ptr r, unsigned indx);
...
extern unsigned bdd_find_leaf_hashed(bdd_manager *bddm, unsigned val,
					  void *some_roots,
					  void (*update_fn)(unsigned (*new_place)(unsigned node)));
